    ...
    <div class="center">
      ...
      <nav>
        <ul class="nospace inline pushright uppercase">
          ...
          <li><a href="<?php echo FRONT_ROOT."Beer/ShowListView"?>">Cervezas</a></li>
          <li><a href="<?php echo FRONT_ROOT."BeerType/ShowListView"?>">Tipos de Cerveza</a></li>
        </ul>
      </nav>
    </div>
  </footer>
...
<div class="wrapper row5">
  <div id="copyright" class="hoc clear"> 
    <p align="center">Copyright &copy; <?php echo date('Y'); ?> - All Rights Reserved - Felipe Gerula(UTN Mar del Plata)</p>
  </div>
</div>
